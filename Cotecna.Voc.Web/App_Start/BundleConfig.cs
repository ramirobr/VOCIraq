...
namespace Cotecna.Voc.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/selectmenucss").Include(
                "~/Content/jquery.ui.selectmenu.css"));

            bundles.Add(new ScriptBundle("~/bundles/selectmenujs").Include(
                        "~/Scripts/jquery.ui.selectmenu.js"));

            bundles.Add(new ScriptBundle("~/bundles/ezmarkjs").Include(
            "~/Scripts/jquery.ezmark.min.js"));
