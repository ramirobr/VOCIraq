...
namespace Cotecna.Voc.Comdiv.Business
{
    ...
    public partial class DICTIONARY
    {
        ...
        public Nullable<int> REF_SUB_ID { get; set; }
        public string DIC_CODE { get; set; }
        public string DIC_ORDER { get; set; }
        public string DIC_DESCRIPTION { get; set; }
        public string DIC_DESCRIPTION_FR { get; set; }
        public string DIC_INFO1 { get; set; }
        public string DIC_INFO2 { get; set; }
        ...
        public string DIC_DESCRIPTION_SPANISH { get; set; }
