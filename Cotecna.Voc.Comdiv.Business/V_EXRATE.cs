...
namespace Cotecna.Voc.Comdiv.Business
{
    ...
    public partial class V_EXRATE
    {
        public int EXR_ID { get; set; }
        public short CONTRACT_ID { get; set; }
        public Nullable<short> CURRTO_ID { get; set; }
        public Nullable<short> CURRFROM_ID { get; set; }
        public Nullable<System.DateTime> EXR_EFF_DATE { get; set; }
        public Nullable<decimal> EXR_RATE { get; set; }
        public string EXR_SOURCE { get; set; }
