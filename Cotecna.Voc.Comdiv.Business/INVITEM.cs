...
namespace Cotecna.Voc.Comdiv.Business
{
    ...
    {
        public int IVI_ID { get; set; }
        public int INV_ID { get; set; }
        public Nullable<byte> IVI_NUMBER { get; set; }
        public string IVI_DESCRIP { get; set; }
        public Nullable<decimal> IVI_AMOUNT { get; set; }
        ...
        public Nullable<decimal> IVI_RATE { get; set; }
        public Nullable<int> IVI_QTY_UNIT_ID { get; set; }
        public Nullable<decimal> IVI_QUANTITY { get; set; }
