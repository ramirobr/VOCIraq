namespace Cotecna.Voc.Silverlight
{
    ...
    public partial class ErrorWindow : ChildWindow
    {
        ...
        {
            if (e.Message.StartsWith("&&"))//the && will indicate that it is a server friendly message 
            {
                return e.Message.Remove(0, 2);
            }
            else
            {
                if (Debugger.IsAttached)
                    ...
                    return "Error at server"; //Strings.CommonErrorOriginatedAtServer;
            }
        }
        #endregion
